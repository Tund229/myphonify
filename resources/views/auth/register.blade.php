                            ...
                            <div class="col-lg-6">
                                <div class="px-5 pb-5">
                                    <div class="text-center">
                                        <a href="#">
                                            <img src="{{ asset('landing_assets/assets/img/logo.png') }}" alt="logo"
                                    ...
                                    <form class="user" action="{{ route('register') }}" method="POST">
                                        ...
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user"
                                                name="password" placeholder="Enter an password">
                                            @error('password')
                                    ...
                                    <div class="text-center">
                                        <a class="small" style="text-decoration:none" href="{{ route('login') }}"><span
                                                style="color: black;">"Do you have an account? </span>Sign In</a>
                                    </div>
                                </div>
                            </div>
                        </div>
